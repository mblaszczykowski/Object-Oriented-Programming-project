...
class KontoOgolne : public KontoAbstrakcyjne {
...
class KategoriaOgolna : public KategoriaAbstrakcyjna {
protected:
	string nazwa;
	string opis;
	Moderator *moderator;
...
class PrzedmiotOgolny : public PrzedmiotAbstrakcyjny {
protected:
	string nazwa;
	string stan;
	string data_dodania;
...
class OgloszenieOgolne : public OgloszenieAbstrakcyjne {
protected:
	string tytul;
	string opis;
...
class PortalOgloszeniowyOgolny : public PortalAbstrakcyjny {
protected:
	string nazwa;
	string data_utworzenia;
